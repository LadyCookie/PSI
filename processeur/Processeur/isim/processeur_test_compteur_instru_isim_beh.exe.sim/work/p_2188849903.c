...
LAB0:    t6 = ((STD_TEXTIO) + 3400);
    ...
    *((char **)t7) = t8;
    t9 = xsi_get_transient_memory(2359296U);
    memset(t9, 0, 2359296U);
    t10 = t9;
    t11 = (36U * 1U);
    t12 = t10;
...
LAB3:    t16 = (t15 + 0U);
    ...
    *((char **)t23) = t22;
    t25 = (t20 + 56U);
    *((char **)t25) = t24;
    memcpy(t24, t9, 2359296U);
    t26 = (t20 + 64U);
    t27 = (t22 + 72U);
    t28 = *((char **)t27);
    *((char **)t26) = t28;
    t29 = (t20 + 80U);
    *((unsigned int *)t29) = 2359296U;
    t30 = (t4 + 132U);
    t31 = ((STD_TEXTIO) + 3248);
    t32 = (t30 + 56U);
    *((char **)t32) = t31;
...
LAB9:    t6 = (t4 + 4U);
    ...
    t6 = (t20 + 56U);
    t7 = *((char **)t6);
    t13 = (2359296U != 2359296U);
    if (t13 == 1)
        goto LAB10;

LAB11:    t0 = xsi_get_transient_memory(2359296U);
    memcpy(t0, t7, 2359296U);
...
LAB8:;
LAB10:    xsi_size_not_matching(2359296U, 2359296U, 0);
    goto LAB11;
...
extern void work_p_2188849903_init()
{
	...
	xsi_register_didat("work_p_2188849903", "isim/processeur_test_compteur_instru_isim_beh.exe.sim/work/p_2188849903.didat");
